...
/**Представьте, что у вас есть функция, которая имитирует запрос к серверу и получает какой-то результат. После получения результата нужно что-то с ним сделать.  */
